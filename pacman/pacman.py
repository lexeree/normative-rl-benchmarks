...
class ClassicGameRules:
    ...
    def newGame( self, layout, pacmanAgent, ghostAgents, display, quiet = False, catchExceptions=False, train=False, monitor=None):
        agents = [pacmanAgent] + ghostAgents[:layout.getNumGhosts()]
        initState = GameState()
        initState.initialize( layout, len(ghostAgents) )
        game = Game(agents, display, self, catchExceptions=catchExceptions, monitor=monitor, train=train)
...
def runGames( layout, pacman, ghosts, display, numGames, record, numTraining = 0, catchExceptions=False, timeout=30, rec=None, monitor=None):
    import __main__
